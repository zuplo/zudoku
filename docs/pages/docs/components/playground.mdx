...
You can use this component to allow users to test your API anywhere in your
documentation.

This component is **only available in [MDX files](/docs/markdown/mdx)**. You can
just use it directly without any imports:
...
The Playground can point to any API endpoint, even if it's not in the API
catalog.
...
endpoint. We can also change the Text on the button to something more specific
to the API.
