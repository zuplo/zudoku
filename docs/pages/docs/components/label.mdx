...
A form label component built on Radix UI primitives with proper accessibility
support.
...
The Label component automatically handles proper accessibility attributes when
