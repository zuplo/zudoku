...
anywhere in your component tree. It uses [`@unhead/react`](https://unhead.unjs.io/) under the hood.
...
The Head component is provided by Unhead, a modern full-stack head management library with
