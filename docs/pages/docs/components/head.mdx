...
tags, and links from anywhere in your component tree.
...
:::tip The Head component is an alias for the Helmet component from React Helmet Async. You can use
either `<Head>` or `<Helmet>` - they're identical. :::

:::info Head tags are merged across components, so you can set some meta tags globally and override
specific ones in individual pages. :::

:::caution Remember that Head tags need to be valid HTML head elements. Invalid elements will be
ignored or may cause issues. :::
