...
By default, Zudoku shows "Use in Claude" and "Use in ChatGPT" options in dropdown menus on both API
reference and documentation pages. You can customize this behavior using the top-level
