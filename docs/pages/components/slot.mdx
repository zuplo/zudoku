...
description: Use the low-level Slot component for advanced slot management in custom pages and MDX content.
---
...
For basic configuration usage, see the [Slots Configuration](/configuration/slots) documentation.
