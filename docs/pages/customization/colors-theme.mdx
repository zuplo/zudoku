...
1. Visit [tweakcn.com](https://tweakcn.com/) to select a preset or customize your theme visually
   ...
   <FramedImage>![](./tweakcn0.png)</FramedImage>
   <FramedImage>![](./tweakcn1.png)</FramedImage>

1. Copy the registry URL from the "Copy" section
   <FramedImage>![](./tweakcn2.png)</FramedImage>
...
The theme will be automatically imported with all color variables, fonts, and styling configured. You can still override specific values if needed:
