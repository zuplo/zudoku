  ...
  },
  {
    ...
    items: [
      ...
      "docs/configuration/api-catalog",
      {
        ...
        icon: "puzzle",
        items: [
          "docs/extensions/x-mcp",
          "docs/extensions/x-mcp-server",
          "docs/extensions/x-code-samples",
          "docs/extensions/x-tag-groups",
          "docs/extensions/x-display-name",
          "docs/extensions/x-internal",
          "docs/extensions/x-zudoku-collapsed",
          "docs/extensions/x-zudoku-collapsible",
          "docs/extensions/x-zudoku-playground-enabled",
        ],
      },
    ],
  },
