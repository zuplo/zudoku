...
import { useCopyToClipboard } from "@zudoku/ui/lib/useCopyToClipboard.js";
import { useLatest } from "@zudoku/ui/lib/useLatest.js";
import { Button } from "@zudoku/ui/ui/Button.js";
import { Collapsible, CollapsibleContent } from "@zudoku/ui/ui/Collapsible.js";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@zudoku/ui/ui/Select.js";
import { TooltipProvider } from "@zudoku/ui/ui/Tooltip.js";
import {
  CheckIcon,
  CopyIcon,
  IdCardLanyardIcon,
...
import { useSelectedServer } from "../hooks/useSelectedServer.js";
import type { ApiIdentity, MediaTypeObject } from "../types.js";
...
export const Playground = ({
  ...
  const authorizationFields = useMemo(
    () => identities?.find((i) => i.id === identity)?.authorizationFields,
    [identities, identity],
  );
      ...
      <TooltipProvider delayDuration={150}>
        <form
          ...
          onSubmit={handleSubmit((data) => {
            if (identities?.length === 0 || data.identity) {
