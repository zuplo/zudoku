...
import type { Arguments } from "../cmds/fill-examples.js";
import { FillExamplesApp } from "./FillExamplesApp.js";

export async function fillExamples(argv: Arguments) {
  ...
  const { waitUntilExit } = render(
    React.createElement(FillExamplesApp, {
