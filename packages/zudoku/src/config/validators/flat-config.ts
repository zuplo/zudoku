...
type InputSidebarItem =
  ...
  | ({
      type?: "category";
      label?: string;
      link?: string | { type?: "doc"; id?: string; label?: string };
      icon?: IconNames;
      description?: string;
      collapsible?: boolean;
      collapsed?: boolean;
