...
type Example = NonNullable<Content[number]["examples"]>[number];
    ...
    <SidecarBox.Root>
      ...
      <SidecarBox.Body className="p-0">
        ...
        {selectedExample?.description && (
          <div className="border-t text-xs px-2 py-1 border-b border-gray-200 dark:border-gray-800">
            {selectedExample.description}
          </div>
        )}
      </SidecarBox.Body>
      {(hasExamples || content.length > 0) && (
