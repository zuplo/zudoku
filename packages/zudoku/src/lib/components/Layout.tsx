...
export const Layout = ({ children }: { children?: ReactNode }) => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 grid-rows-[0_min-content_1fr] lg:grid-rows-[min-content_1fr] lg:grid-cols-[var(--side-nav-width)_1fr] max-w-screen-2xl w-full lg:mx-auto px-4 lg:ps-0 lg:pe-8">
