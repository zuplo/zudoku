...
Welcome to the Cosmo Cargo. We provide a comprehensive suite of shipping and
logistics services that enable businesses to seamlessly integrate shipping
functionality into their applications.

Our API provides a comprehensive suite of shipping and logistics services that
enable businesses to seamlessly integrate shipping functionality into their
applications.
...
All API requests require authentication using an API key, which should be
included in the `X-API-Key` header. To obtain an API key, please contact our
...
- Documentation:
  [https://developers.sh.example.com](https://developers.sh.example.com)
